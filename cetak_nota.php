...
function Header()
{
    ...
    $this->Cell(30,10,'TOSERBA');

    $this->Ln(10);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Jl Pandanaran, Boyolali, Jawa Tengah');

    $this->cell(80);
    $this->SetFont('Arial','',10);
    $this->cell(30,10,'Boyolali, '.base64_decode($_GET['uuid']).'');
    $this->Line(10,40,200,40);

    $this->Ln(5);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Telp/Fax : 0812-345-678-123');
    $this->Line(10,40,200,40);
...
$pdf->Output('','TOSERBA/'.$filename.'.pdf');
?>
